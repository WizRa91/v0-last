...
export default async function BeenTherePage() {
  ...
  if (error) {
    console.error("Error fetching 'been there' sites:", error)
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] theme-primary-bg py-8 px-4 md:px-8">
      <div className="container mx-auto max-w-6xl">
        ...
        <h1 className="text-4xl font-display theme-text mb-6">Sites You've Been To</h1>
        <SiteList sites={userSites} emptyMessage="You haven't marked any sites as 'Been There' yet." />
      </div>
    </div>
  )
}
