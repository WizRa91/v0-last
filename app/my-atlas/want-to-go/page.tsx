...
export default async function WantToVisitPage() {
  ...
  if (error) {
    console.error("Error fetching 'want to go' sites:", error)
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] theme-primary-bg py-8 px-4 md:px-8">
      <div className="container mx-auto max-w-6xl">
        ...
        <h1 className="text-4xl font-display theme-text mb-6">Your 'Want to Go' List</h1>
        <SiteList sites={userSites} emptyMessage="Your wishlist is empty. Explore the map to add sites!" />
      </div>
    </div>
  )
}
